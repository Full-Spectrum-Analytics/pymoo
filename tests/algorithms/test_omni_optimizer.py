...
from pymoo.algorithms.moo.omni_optimizer import (
    BOUNDARY,
    LooseDominator,
...
def test_omni_optimizer_converges_on_omni_test():
    problem = OmniTest(n_var=2)
...
def test_omni_optimizer_maintains_multiple_pareto_subsets():
...
def test_omni_optimizer_is_deterministic():
    problem = OmniTest(n_var=2)
